...
const SCHEDULE_MAP = {
  '01:30-19-3': { title: 'おーい！あと20分だよ！', body: 'くまさんだよ！バス組は東京駅に10:50集合！現地組は12:40にワーズワースで待ってるよ！遅刻だけはダメだからね！' },
  '03:30-19-3': { title: 'お腹すいたー！ごはん！', body: 'もうすぐイタリアンだよ！12:40〜ワーズワースに全員集合！くまさんの分も食べてきてね…' },
  '05:55-19-3': { title: 'そろそろホテルだよ〜！', body: '15:00からチェックインできるよ！17:15までにKAGURAへGO！荷物おろしてゆっくりしてね〜' },
  '06:45-19-3': { title: 'そろそろ自由行動の時間！', body: '申し込んだ人は和菓子作り体験が16:00〜岩立本店ではじまるよ！それ以外の人はまったり過ごしてね' },
  ...
  '00:45-20-3': { title: 'そろそろ午前の時間だよ！', body: '香取神宮に行く人は10:00集合でタクシー相乗り！お部屋でゆっくり派もいい朝を過ごしてね' },
  '02:45-20-3': { title: 'そろそろお片付け！', body: '12:00チェックアウトだよ！忘れ物ないかな？荷物はホテルに預けられるから安心してね' },
  '04:45-20-3': { title: '午後の時間だよ！', body: '申し込んだ人はアクティビティが14:00〜はじまるよ！自由に過ごす人も佐原を楽しんでね' },
  '06:50-20-3': { title: 'みんなで振り返り！', body: '16:00〜いなえで中締めだよ！参加できる人はぜひ！楽しかった思い出をみんなで語ろう' },
  '08:20-20-3': { title: 'おつかれさま！楽しかったね！', body: 'くまさんからありがとう！みんなと過ごせて最高だったよ！バス組は17:42発だから気をつけて帰ってね！' },
};

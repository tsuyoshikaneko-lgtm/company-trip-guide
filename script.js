...
const TripNotifications = (() => {
  ...
  const PROD_SCHEDULE = [
    ...
    { time: [3, 19, 15, 45], title: '和菓子つくるよ！', body: 'あと15分で和菓子作り体験はじまるよ！岩立本店に集合！くまさんの分もひとつ…お願い…', tag: 'day1-wagashi' },
    ...
    { time: [3, 20, 9, 45],  title: '神宮いく人〜！', body: 'あと15分で香取神宮に出発だよ！10:00集合でタクシー相乗り！ご利益あるといいね！', tag: 'day2-shrine' },
    { time: [3, 20, 11, 45], title: 'そろそろお片付け！', body: '12:00チェックアウトだよ！忘れ物ないかな？荷物はホテルに預けられるから安心してね', tag: 'day2-checkout' },
    { time: [3, 20, 13, 45], title: 'アクティビティだ！', body: '14:00〜酒粕入浴剤づくり＆ドレッシング作りがはじまるよ！お土産にもなるね！いいなー！', tag: 'day2-activity1' },
    { time: [3, 20, 14, 45], title: 'ドレッシング組〜！', body: '15:00の部がもうすぐ！醸し処 和ぎへGO！ホテルから徒歩2分だよ！発酵ってすごいよね', tag: 'day2-activity2' },
    { time: [3, 20, 15, 50], title: 'みんなで振り返り！', body: '16:00〜いなえで中締めだよ！楽しかった思い出をみんなで語ろう！くまさんも聞きたいなー', tag: 'day2-closing' },
